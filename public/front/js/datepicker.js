...
var Datepicker = (function () {
    ...
    var Datepicker = function Datepicker(input, options) {
        ...
        this.minDays = opts.minDays || 0;
        this.maxDays = opts.maxDays || 0;
        ...
        this.i18n = opts.i18n || {
            ...
            "info-more-plural":
                "Please select a date range of at least %d days",
    ...
    Datepicker.prototype.addBoundedListener = function addBoundedListener(
        node,
        event,
        handler,
        capture
    ...
    Datepicker.prototype.removeAllBoundedListeners =
    ...
    Datepicker.getNewId = function getNewId() {
        return ++idCounter;
    };

    Datepicker.prototype.setFechaI18n = function setFechaI18n() {
    ...
    Datepicker.prototype.getCloseButtonId = function getCloseButtonId() {
        // Get close button ID
        return "close-" + this.generateId();
    };

    Datepicker.prototype.getClearButtonId = function getClearButtonId() {
        // Get close button ID
        return "clear-" + this.generateId();
    };

    Datepicker.prototype.getSubmitButtonId = function getSubmitButtonId() {
        // Get close button ID
    ...
    Datepicker.prototype.init = function init() {
        ...
        this.minDays = this.minDays > 0 ? this.minDays + 0 : 0;

        // Set the maximum of days required by the daterange
        this.maxDays = this.maxDays > 0 ? this.maxDays + 1 : 0;
    ...
    Datepicker.prototype.addListeners = function addListeners() {
        ...
        if (this.showTopbar && this.clearButton) {
            ...
            document
                ...
                .addEventListener("click", function (evt) {
                    return this$1.clearDatepicker(evt);
                });
        }
        ...
        window.addEventListener("resize", function (evt) {
            return this$1.onResizeDatepicker(evt);
        });
    ...
    Datepicker.prototype.createDatepickerDomString =
    ...
    Datepicker.prototype.createMonthDomString = function createMonthDomString(
        _date
    ) {
        var this$1 = this;
        ...
        if (dayOfWeek > 0) {
            for (var i = dayOfWeek; i > 0; i--) {
                ...
                if (
                    ...
                    (this$1.endDate &&
                        this$1.compareDay(_day, this$1.endDate) > 0)
                ) {
                    valid = false;
                }
        ...
        for (var i$1 = 0; i$1 < 40; i$1++) {
            ...
            if (
                ...
                (this$1.endDate &&
                    this$1.compareDay(_day$1, this$1.endDate) > 0)
            ) {
                valid = false;
            }
        ...
        for (var week = 0; week < 6; week++) {
            ...
            for (var i$2 = 0; i$2 < 7; i$2++) {
                ...
                if (
                    this$1.hasClass(_day$2, "datepicker__month-day--no-checkin")
                ) {
    ...
    Datepicker.prototype.datepickerHover = function datepickerHover(evt) {
    ...
    Datepicker.prototype.datepickerMouseOut = function datepickerMouseOut(evt) {
    ...
    Datepicker.prototype.onResizeDatepicker = function onResizeDatepicker() {
        // Reset month views
        this.checkAndSetDefaultValue(true);
    };

    Datepicker.prototype.getDayClasses = function getDayClasses(_day) {
        var isToday =
    ...
    Datepicker.prototype.checkAndSetDayClasses =
        function checkAndSetDayClasses() {
            var this$1 = this;
            ...
            for (var i = 0; i < days.length; i++) {
                ...
                if (
                    (this$1.startDate &&
                        this$1.compareDay(day, this$1.startDate) < 0) ||
                    (this$1.endDate &&
                        this$1.compareDay(day, this$1.endDate) > 0)
                ) {
                    valid = false;
                }
    ...
    Datepicker.prototype.checkAndSetDefaultValue =
        function checkAndSetDefaultValue(onresize) {
    ...
    Datepicker.prototype.setDateRange = function setDateRange(
        date1,
        date2,
        onresize
    ) {
    ...
    Datepicker.prototype.dayClicked = function dayClicked(day) {
        ...
        if (isSelectStart) {
            ...
            var startDayEl = this.datepicker.querySelectorAll(
                'td[time="' + this.start + '"]'
            )[0];
    ...
    Datepicker.prototype.isValidDate = function isValidDate(time) {
        ...
        if (this.start && !this.end) {
            ...
            if (this.disabledDates.length > 0) {
                var limit = this.getClosestDisabledDates(
                    new Date(parseInt(this.start, 10))
                );
            ...
            if (this.disabledDaysOfWeek.length > 0) {
                var limit$1 = this.getClosestDisabledDays(
                    new Date(parseInt(this.start, 10))
                );
    ...
    Datepicker.prototype.substractDays = function substractDays(date, days) {
    ...
    Datepicker.prototype.disableNextPrevButtons =
    ...
    Datepicker.prototype.topBarErrorText = function topBarErrorText(
        bar,
        errorText,
        errorValue
    ) {
    ...
    Datepicker.prototype.updateSelectableRange =
    ...
    Datepicker.prototype.dayHovering = function dayHovering(day) {
        ...
        if (!this.hasClass(day, "datepicker__month-day--invalid")) {
            ...
            if (this.start && !this.end) {
                var days = this.countDays(hoverTime, this.start) - 1;
                ...
                if (this.hoveringTooltip) {
                    ...
                    } else if (this.hoveringTooltip === true) {
                        var label =
                            days === 1 || days === 0
                                ? this.lang("day")
                                : this.lang("days");
        ...
        if (tooltip) {
            ...
            var tooltipContainer$1 = document.getElementById(
                this.getTooltipId()
            );
    ...
    Datepicker.prototype.clearDatepicker = function clearDatepicker() {
        var this$1 = this;
    ...
    Datepicker.prototype.getClosestDisabledDates =
        function getClosestDisabledDates(x) {
            var this$1 = this;
            ...
            if (x < this.disabledDatesTime[0]) {
                ...
                if (
                    typeof this.disabledDatesTime[bestPrevDate] === "undefined"
                ) {
                    dates[1] = false;
                    // Add one day if we want include the checkout
    ...
    Datepicker.prototype.getDisabledDays = function getDisabledDays() {
        var this$1 = this;
    ...
    Datepicker.prototype.getClosestDisabledDays =
        function getClosestDisabledDays(day) {
            var this$1 = this;
            ...
            for (var i = 0; i < 7; i++) {
                ...
                if (
                    this$1.disabledDaysIndexes.indexOf(
            ...
            for (var i$1 = 0; i$1 < 7; i$1++) {
                ...
                if (
                    this$1.disabledDaysIndexes.indexOf(
                        parseInt(fecha.format(_date$1, "d"), 10)
                    ) > -1
                ) {
                    dates[1] = _date$1;
                    break;
