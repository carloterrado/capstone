$(function () {
    ...
    $("#front-signup-first-name").on("keyup keypress", function () {
        validateName(
            "#front-signup-first-name",
            "#front-signup-first-name-error",
            "Name"
        );
    });
    $("#front-signup-last-name").on("keyup keypress", function () {
        validateName(
            "#front-signup-last-name",
            "#front-signup-last-name-error",
            "Lastname"
        );
    });
    ...
    $("#front-signup-birthdate").on("keyup keypress", function () {
        validateBirthdate(
            "#front-signup-birthdate",
            "#front-signup-birthdate-error"
        );
    });
    ...
    $("#front-signup-password").on("keyup keypress", function () {
        validatePassword(
            "#front-signup-password",
            "#front-signup-password-error"
        );
    });
    $("#front-signup-confirm-password").on("keyup keydown", function () {
        validateConfirmPassword(
            "#front-signup-password",
            "#front-signup-confirm-password",
            "#front-signup-confirm-password-error"
        );
    });
    $("#front-signup-valid-id").on("click keypress", function (event) {
        validateValidID(
            "#front-signup-valid-id",
            "#front-signup-valid-id-error"
        );
    });
    $("#front-signup-id-file").on("change", function () {
        validateImageFile(
            "#front-signup-id-file",
            "#front-signup-id-file-error"
        );
    });
    ...
    $("#front-signup-form").on("submit", async function (event) {
        ...
        async function validateSignupForm() {
            let valid =
                ...
                validateContact(
                    "#front-signup-contact",
                    "#front-signup-contact-error"
                ) &&
                validateAddress(
                    "#front-signup-address",
                    "#front-signup-address-error"
                ) &&
                validatePassword(
                    "#front-signup-password",
                    "#front-signup-password-error"
                ...
                validateTerms(
                    "#front-signup-terms",
                    "#front-signup-terms-error"
                );

            if (!valid) {
                //  event.preventDefault();
                $("#front-signup-submit-form-error").show();
                $("#front-signup-submit-form-error").text(
            ...
            await $.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp["status"] === "success") {
                        ...
                        $(
                            '#front-signup-form button[type="submit"]'
                        ).removeClass("hidden");
                        setTimeout(function () {
                ...
                error: function () {
                    ...
                    $(".error-container").show();
                    $(".error-message").html(
                        "System account registration failed!"
                    );
                    $('#front-signup-form button[type="submit"]').removeClass(
                        "hidden"
                    );
                    setTimeout(function () {
                        $(".error-container").hide();
    ...
    $("#front-login-form").on("submit", function (event) {
        ...
        function validateLoginForm() {
            ...
            if (!valid) {
                ...
                $("#front-login-submit-form-error").text(
                    "Please fill up the form correctly!"
                );
                setTimeout(function () {
            ...
            await $.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp["status"] === "active") {
                        ...
                        $(".error-container").show();
                        $(".error-message").html(
                            "Please check your email first and verify your account!"
                        );
                        $(
                ...
                error: function () {
                    ...
                    $('#front-login-form button[type="submit"]').removeClass(
                        "hidden"
                    );
                    setTimeout(function () {
                        $(".error-container").hide();
        ...
        async function submitPassword() {
            ...
            await $.ajax({
                ...
                error: function () {
                    ...
                    $('#change-pass-form button[type="submit"]').removeClass(
                        "hidden"
                    );
                    setTimeout(function () {
                        $(".error-container").show();
        ...
        async function submitSignupForm() {
            await $.ajax({
                ...
                error: function () {
                    ...
                    $(".error-container").show();
                    $(".error-message").html(
                        "System error update details failed!"
                    );
                    $('#edit-profile-form button[type="submit"]').removeClass(
                        "hidden"
                    );
                    setTimeout(function () {
                        $(".error-container").hide();
    ...
    $tabLinks.each(function () {
        if ($(this).attr("aria-selected") === "true") {
            $(this)
                .removeClass("text-blue-600 border-blue-600 border-transparent")
                .addClass("text-accent-regular border-accent-regular");
        }
    });
    ...
    $(document).on("click", '[role="tab"]', function () {
        if ($([(role = "tab")]).hasClass("transaction-tab")) {
            ...
            $('[role="tab"]')
                .attr("class", "")
                .addClass(
                    "text-gray-500 hover:text-accent-regular border-gray-100 hover:border-accent-regular inline-block p-4 border-b-2 border-transparent rounded-t-lg sm:text-lg lg:text-2xl font-bold transaction-tab"
                );
            // Add aria-selected attribute to clicked tab link
            $(this).attr("aria-selected", "true");
            $(this)
                .removeClass("text-gray-500 border-gray-100 border-transparent")
                .addClass("text-accent-regular border-accent-regular");
        } else {
            // Remove aria-selected attribute from current active tab
            $('[role="tab"]').attr("aria-selected", "false");
            $('[role="tab"]')
                .attr("class", "")
                .addClass(
                    "text-gray-500 hover:text-accent-regular border-gray-100 hover:border-accent-regular inline-block p-4 border-b-2 border-transparent rounded-t-lg uppercase"
                );
            // Add aria-selected attribute to clicked tab link
            $(this).attr("aria-selected", "true");
            $(this)
    ...
    $(document).on("click", ".booking-btn", function (event) {
        $(".booking-btn")
            .removeAttr("class")
            .addClass(
                "booking-btn inline-block hover:text-accent-regular hover:border-accent-regular p-4 border-b-2 border-transparent rounded-t-lg sm:text-lg lg:text-2xl font-bold"
            );
    ...
    function updateFee(element, fee, driverFee, times, text) {
        $(element).text(
            text +
                (
                    (parseFloat(fee) + parseFloat(driverFee)).toFixed(2) * times
    ...
    $(".step-2").on("click", async function (event) {
        if (event.target === this) {
            ...
            async function openStepTwo() {
                ...
                const valid =
                    stepOneValidation(dateInput) &&
                    stepOneValidation(timeInput) &&
                    stepOneValidation(timeEndInput) &&
                    stepOneValidation(regionID) &&
                    stepOneValidation(provinceID) &&
                    stepOneValidation(cityID);
                ...
                if (valid) {
                    ...
                    driver === "0"
                        ? $(stepTwo).find(".confirm-driver").text("Self Drive")
                        : $(stepTwo)
                              .find(".confirm-driver")
                              .text("With Driver");

                    var dates = dateInput.split(" - ");
                    var startDate = new Date(dates[0]).toLocaleDateString(
                        "en-us",
                        {
                            weekday: "short",
                            year: "numeric",
                    ...
                    var endDate = new Date(dates[1]).toLocaleDateString(
                        "en-us",
                        {
                            weekday: "short",
                            year: "numeric",
                    ...
                    var formattedTimeEndInput =
                        hoursEnd + ":" + minutesEnd + " " + ampmEnd;

                    // DISPLAY START AND END DATE
                    $(stepTwo)
                        .find(".confirm-start-date")
                        .text(startDate + " " + formattedTimeInput);
                    $(stepTwo)
                        .find(".confirm-end-date")
                        .text(endDate + " " + formattedTimeEndInput);

                    // Combine the dates and times into timestamps
                    var startTimestamp = Date.parse(`${dates[0]} ${timeInput}`);
                    var endTimestamp = Date.parse(
                        `${dates[1]} ${timeEndInput}`
                    );
                    ...
                    if (driver === "0") {
                        ...
                        var initialDriverFee = $(stepTwo)
                            .find(".driver")
                            .data("driver");
                        $(stepTwo)
                            .find(".driver-price")
                            .val(parseFloat(initialDriverFee));
                    }
                    ...
                    var confirmDriverFee = $(stepTwo).find(
                        ".confirm-driver-fee"
                    );
                    ...
                    $(stepTwo)
                        .find(".car-price")
                        .val(parseFloat(newPrice) * bookDays);
                    $(stepTwo)
                        .find(".driver-price")
                        .val(parseFloat(driverFee) * bookDays);
                    $(stepTwo)
                        .find(".total-price")
                        .val(
                            (parseFloat(newPrice) + parseFloat(driverFee)) *
                                bookDays
                        );
    ...
    $(".step-3").on("click", async function (event) {
        if (event.target === this) {
            ...
            async function openStepThree() {
                ...
                if (driver === "1") {
                    valid =
                        fullName(fullname, fullNameError, "Full Name") &&
                        contact(contactNumber, contactNumberError) &&
                        fileImage(validIDImg, validIDImgError, "Valid ID") &&
                        fileImage(
                            validIDImg2,
                            validIDImg2Error,
                            "Another Valid ID"
    ...
    $(document).on("submit", ".car-booking-form", async function (event) {
        ...
        if (event.target === this) {
            ...
            async function validateBookingForm() {
                ...
                const timeEndInput = $(bookingForm)
                    .find(".time-end-input")
                    .val();
            ...
            async function submitBookingForm() {
                await $.ajax({
                    ...
                    success: function (resp) {
                        ...
                        if (resp["data"] === "success") {
                            ...
                            $(bookingForm)
                                ...
                                .html("Car booking submitted successfully!");
                            setTimeout(function () {
                    ...
                    error: function () {
                        ...
                        $(bookingForm)
                            .find(".error-message")
                            .html("System error add car failed!");
                        $(bookingForm).find('button[type="submit"]').show();
                        setTimeout(function () {
                            $(".error-container").hide();
                        }, 3000);
            ...
            if (validated) {
                ...
                await submitBookingForm().catch(function (error) {
                    ...
                    $(bookingForm)
                        .find(".error-message")
                        .html(
                            "File size is too large! recommended 250 KB or lower"
                        );
    ...
    $(document).on("submit", ".reg-fee-form", async function (event) {
        ...
        if (event.target === this) {
            ...
            async function validateRegFeeForm() {
                ...
                const senderNumberErrorElement =
                    $(senderNumberEl).siblings("label");
                ...
                let valid =
                    contact(
                        senderNumberEl,
                        senderNumberErrorElement,
                        "GCash Number"
                    ) && amount(amountEl, amountErrorElement, "Amount");
            ...
            if (validated) {
                ...
                await submitRegFeeForm().catch(function (error) {
                    ...
                    $(form)
                        .find(".error-message")
                        .html("System, Pay registration failed!");
                    setTimeout(function () {
    ...
    $("#ongoing-transaction-table").on("click",".cancelBooking", async function (event) {
            ...
            await $.ajax({
                ...
                error: function (resp) {
                    ...
                    $(".error-container").show();
                    $(".error-message").html(
                        "Booking cancel failed! System error."
                    );
                    $(cancelButton).show();
                    setTimeout(function () {
                        $(".error-container").hide();
    ...
    $("#ongoing-transaction-table").on("click", ".confirmDelete", async function () {
            ...
            await $.ajax({
                ...
                error: function (resp) {
                    ...
                    $(".error-container").show();
                    $(".error-message").html(
                        "Booking deletion failed! System error."
                    );
                    setTimeout(function () {
                        $(".error-container").hide();
                    }, 3000);
            ...
            await $.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp["data"] === "success") {
                        ...
                        $(checklist)
                            .find(".error-message")
                            .html("Failed to confirmed checklist!");
                        setTimeout(function () {
                            $(".error-container").hide();
                        }, 6000);
                    }
                ...
                error: function (resp) {
                    ...
                    $(checklist)
                        .find(".error-message")
                        .html("Confirm checklist failed! System error.");
                    setTimeout(function () {
    ...
    $("#ongoing-transaction-table").on("click", ".confirmReturn", async function () {
            ...
            await $.ajax({
                ...
                error: function (resp) {
                    ...
                    $(".error-container").show();
                    $(".error-message").html(
                        "Booking return failed! System error."
                    );
                    setTimeout(function () {
                        $(".error-container").hide();
                    }, 3000);
    ...
    function showContent(id, $link) {
        ...
        $termsLinks
            .removeClass("text-accent-regular underline")
            .addClass("text-black ");
        $link
            .removeClass("text-black ")
            .addClass("text-accent-regular underline");
    }
