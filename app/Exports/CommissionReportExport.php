...
class CommissionReportExport implements FromCollection, WithHeadings, WithCustomStartCell, WithStyles
{
    /**
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('Q1', 'Monthly Commission Sales Report');
        ...
        $sheet->setCellValue('U1', 'Yearly Commission Sales Report');
        ...
        $sheet->getStyle('I2:L' . ($sheet->getHighestRow()))->getNumberFormat()->setFormatCode('₱ #,##0.00');
