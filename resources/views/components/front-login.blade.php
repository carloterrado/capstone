...
<div class="flex justify-center min-h-[90vh] relative sm:py-6 lg:py-0">
    ...
    <div class="bg-white flex items-center w-full max-w-md px-6 m-auto lg:w-2/6">
        <div class="flex-1">
            ...
            <div class="mt-8">
                <form id="front-login-form" action="{{url('arkilla-login')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                    <div class="relative">
                    ...
                    <div class="my-6 ">
                        <button type="submit" class="btn-orange-login scale-75 sm:scale-100">
                            Submit
                        </button>
                    </div>
