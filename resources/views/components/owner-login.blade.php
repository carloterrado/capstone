    ...
    <div class="bg-white flex items-center w-full max-w-md px-6 m-auto lg:w-2/6">
        <div class="flex-1">
            <div class="text-center">
                ...
                <div id="success" class="flex p-4 mb-4 bg-green-500 rounded-lg " role="alert">
                    <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5 text-white " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <span class="sr-only">Hi!</span>
                    <div class="ml-3 text-sm font-medium text-white ">
                    {{Session::get('success_message')}}
                    </div>
                    <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-green-100 text-white rounded-lg focus:ring-0  p-1.5 hover:bg-green-200 inline-flex h-8 w-8 " data-dismiss-target="#success" aria-label="Close">
