...
<nav class="relative px-4 md:px-12 flex justify-between items-center bg-white shadow-sm">
    ...
    <div class="hidden lg:flex justify-between">
        <div class="hidden lg:flex justify-between gap-3">
            <button class="front-login btn-1 btn-non-orange" >Login</button>
            <button class="front-signup btn-1 btn-orange-1" >Sign up</button>
        </div>
        <!-- Profile -->
        <div class="hidden items-center md:order-2 mr-[1rem]">
