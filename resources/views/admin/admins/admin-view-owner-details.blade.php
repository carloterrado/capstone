        ...
        <div class="relative w-full max-w-2xl m-auto bg-white rounded-lg">
            ...
            <form  class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex justify-between items-start p-4 rounded-t ">
                    ...
                    <button data-modal-toggle="{{'admin'.$admin['id']}}"  type="button" class="close text-gray-400 bg-transparent hover:bg-accent-regular hover:text-white rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" >
