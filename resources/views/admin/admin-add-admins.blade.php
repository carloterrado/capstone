    ...
    <div class="relative w-full max-w-2xl m-auto">
        ...
        <form id="add-admin-form" method="POST" class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                ...
                <button data-modal-toggle="add-admins" type="button" class=" text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" >
