    ...
    <div class="relative w-full max-w-2xl m-auto">
        ...
        <form id="edit-car-type-form" method="POST" class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                ...
                <button data-modal-toggle="edit-cartype" type="button" class="cursor-pointer text-gray-400 bg-transparent hover:bg-accent-regular hover:text-white rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" >
