                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            <label id="edit-admin-car-registration-error" for="edit-admin-car-registration" class="block pb-1 text-sm font-semibold lg:pl-2 text-gray-500" >Car registration</label>
                            <input id="edit-admin-car-registration" name="edit-admin-car-registration" type="file" class="block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" aria-describedby="file_input_help">
                        </div>
                        @endif
                        <div class="col-span-6">
                        ...
                        <div class="col-span-6">
                            <label id="edit-admin-car-photos-error" for="edit-admin-car-photos" class="block pb-1 text-sm font-semibold lg:pl-2 text-gray-500" >Photos of car(min 2)</label>
