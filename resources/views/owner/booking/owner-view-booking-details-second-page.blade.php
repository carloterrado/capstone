            ...
            <div class="form-step step-one pb-6">
                ...
                <div class="px-2 sm:px-6 grid grid-cols-8 gap-x-6">
                    <div class="col-span-8 md:col-span-5 mb-6">
                        ...
                        <!-- Tab content -->
                        <div id="{{'car-content2'.$book['id']}}">
                            <!-- USER DETAILS  -->
                            <div class="hidden p-4" id="{{'car-description2'.$book['id']}}" role="tabpanel" aria-labelledby="{{'car-description-tab2'.$book['id']}}">
                            ...
                            <!-- USER IDs -->
                            <div class="hidden " id="{{'car-excluded2'.$book['id']}}" role="tabpanel" aria-labelledby="{{'car-excluded-tab2'.$book['id']}}">
