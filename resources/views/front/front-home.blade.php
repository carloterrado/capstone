<main id="home">
    ...
    <!-- Car section -->
    <section class="bg-[#F5F5F5] px-2 py-6 sm:py-16  sm:px-24 " data-scrolly-down="blurInTop, timing-function:cubic-bezier(.17,.67,.83,.67)" data-scrolly-offset-top="100px" data-scrolly-offset-bottom="50px">
        <div class="font-bold mb-6 md:mb-10" data-scrolly-down=" moveFromBottom, timing-function:cubic-bezier(.17,.67,.83,.67)">
            <h2 class="text-center text-[1.5rem] lg:text-[2.5rem]  leading-none">Featured <span class="text-accent-regular">Cars</span></h2>
        </div>
        <div class="grid grid-cols-6 gap-4 w-full mx-auto owl-carousel owl-theme overflow-hidden uppercase" data-scrolly-down="moveFromBottom, timing-function:cubic-bezier(.17,.67,.83,.67), delay:0.5s">
    ...
    <section class="bg-white p-6 sm:p-14 flex flex-col gap-6 sm:gap-24 justify-between" data-scrolly-down="blurInTop timing-function:cubic-bezier(.17,.67,.83,.67)" data-scrolly-offset-top="200px">
        <div class="font-bold" data-scrolly-down=" moveFromBottom, timing-function:cubic-bezier(.17,.67,.83,.67)">
        ...
        <div class="flex justify-center flex-wrap sm:flex-nowrap text-center">
            <div class="max-w-[400px] py-6 sm:px-6 border-t border-t-accent-regular sm:border-t-0 sm:border-r sm:border-r-accent-regular" data-scrolly-down=" moveFromLeft, timing-function:cubic-bezier(.17,.67,.83,.67)">
            ...
            <div class="max-w-[400px] py-6 sm:px-6 border-t border-t-accent-regular sm:border-t-0" data-scrolly-down="moveFromBottom, timing-function:cubic-bezier(.17,.67,.83,.67)">
                <div class="flex justify-center">
            ...
            <div class="max-w-[400px] pt-6 lg:px-6 border-t border-t-accent-regular sm:border-t-0  sm:border-l sm:border-l-accent-regular" data-scrolly-down="moveFromRight, timing-function:cubic-bezier(.17,.67,.83,.67)">
                <div class="flex justify-center">
    ...
    <section class="bg-[#F5F5F5] px-6 pb-14 sm:p-14 gap-4 grid sm:grid-cols-2 lg:grid-cols-4" data-scrolly-down="blurInTop, timing-function:cubic-bezier(.17,.67,.83,.67)" data-scrolly-offset-top="200px">
        <div class="py-10  sm:h-[400px] sm:flex sm:flex-col sm:justify-end" data-scrolly-down=" moveFromBottom, timing-function:cubic-bezier(.17,.67,.83,.67)">
        ...
        <div class="py-10 px-8 sm:h-[400px] bg-white relative before:absolute before:left-0 before:-bottom-[2px] before:content-[''] before:h-[3px] before:w-full before:bg-accent-regular before:scale-x-0 before:origin-right hover:before:scale-x-100 hover:before:origin-left before:transition-transform before:duration-500" data-scrolly-down="moveFromRight, delay:0.5s, timing-function:cubic-bezier(.17,.67,.83,.67)">
    ...
    <section class="bg-white p-6 sm:p-14 grid gap-8 md:grid-cols-2" data-scrolly-down="blurInTop" data-scrolly-offset-top="200px">
        <div class="sm:h-[fit-content] relative">
            <div class="mb-8 lg:-translate-y-6" data-scrolly-down="moveFromLeft, timing-function:cubic-bezier(.17,.67,.83,.67)">
            ...
            <div>
                <ul class="grid sm:grid-cols-2 gap-y-8 gap-x-4">
                    <li class="flex gap-2 items-center" data-scrolly-down="moveFromLeft, delay:0.5s, timing-function:cubic-bezier(.17,.67,.83,.67)">
                        <div class="h-10 w-10">
                        ...
                        <span>We will help you to reach wider audience</span></li>
                    <li class="flex gap-2 items-center" data-scrolly-down="moveFromRight, delay:0.5s, timing-function:cubic-bezier(.17,.67,.83,.67)">
                        <div class="h-10 w-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10"  viewBox="0 0 24 24"><path fill="#e84949" d="m10.6 13.8l-2.175-2.175q-.275-.275-.675-.275t-.7.3q-.275.275-.275.7q0 .425.275.7L9.9 15.9q.275.275.7.275q.425 0 .7-.275l5.675-5.675q.275-.275.275-.675t-.3-.7q-.275-.275-.7-.275q-.425 0-.7.275ZM12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"/></svg>    
                        </div>   
                        <span>We'll make sure users are thoroughly reviewed to avoid frauds and scams</span></li>
                    <li class="flex gap-2 items-center" data-scrolly-down="moveFromLeft, delay:0.8s, timing-function:cubic-bezier(.17,.67,.83,.67)">
                        <div class="h-10 w-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10"  viewBox="0 0 24 24"><path fill="#e84949" d="m10.6 13.8l-2.175-2.175q-.275-.275-.675-.275t-.7.3q-.275.275-.275.7q0 .425.275.7L9.9 15.9q.275.275.7.275q.425 0 .7-.275l5.675-5.675q.275-.275.275-.675t-.3-.7q-.275-.275-.7-.275q-.425 0-.7.275ZM12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"/></svg>    
                        </div>   
                        <span>You can provide transportation for people who don't own a car</span></li>
                    <li class="flex gap-2 items-center" data-scrolly-down="moveFromRight, delay:0.8s, timing-function:cubic-bezier(.17,.67,.83,.67)">
                        <div class="h-10 w-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10"  viewBox="0 0 24 24"><path fill="#e84949" d="m10.6 13.8l-2.175-2.175q-.275-.275-.675-.275t-.7.3q-.275.275-.275.7q0 .425.275.7L9.9 15.9q.275.275.7.275q.425 0 .7-.275l5.675-5.675q.275-.275.275-.675t-.3-.7q-.275-.275-.7-.275q-.425 0-.7.275ZM12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"/></svg>    
                        </div>    
                        <span>Experience optimized data collection and reservation process</span></li>
                    <li class="flex gap-2 items-center" data-scrolly-down="moveFromLeft, delay:1s, timing-function:cubic-bezier(.17,.67,.83,.67)">
                        <div class="h-10 w-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10"  viewBox="0 0 24 24"><path fill="#e84949" d="m10.6 13.8l-2.175-2.175q-.275-.275-.675-.275t-.7.3q-.275.275-.275.7q0 .425.275.7L9.9 15.9q.275.275.7.275q.425 0 .7-.275l5.675-5.675q.275-.275.275-.675t-.3-.7q-.275-.275-.7-.275q-.425 0-.7.275ZM12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"/></svg>    
                        </div>
                        <span>You can choose when to make your car available for rent.</span></li>
                    <li class="flex gap-2 items-center" data-scrolly-down="moveFromRight, delay:1s, timing-function:cubic-bezier(.17,.67,.83,.67)">
                        <div class="h-10 w-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10"  viewBox="0 0 24 24"><path fill="#e84949" d="m10.6 13.8l-2.175-2.175q-.275-.275-.675-.275t-.7.3q-.275.275-.275.7q0 .425.275.7L9.9 15.9q.275.275.7.275q.425 0 .7-.275l5.675-5.675q.275-.275.275-.675t-.3-.7q-.275-.275-.7-.275q-.425 0-.7.275ZM12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"/></svg>    
                        </div>
        ...
        <div class="max-h-[500px] relative" data-scrolly-down="moveFromBottom, timing-function:cubic-bezier(.17,.67,.83,.67)">
    ...
    <!-- Book Now section -->
    <section class="bg-white p-6 sm:p-14  grid gap-16 md:grid-cols-2" data-scrolly-down="blurInTop timing-function:cubic-bezier(.17,.67,.83,.67)" data-scrolly-offset-top="200px">  
        <div class="h-[200px] w-full sm:h-full max-h-[85vh]  relative" data-scrolly-down="moveFromLeft, delay:0.5s, timing-function:cubic-bezier(.17,.67,.83,.67)">
        ...
        <div class=" relative ">
            <div class="mb-8 lg:-translate-y-5" data-scrolly-down="moveFromRight, timing-function:cubic-bezier(.17,.67,.83,.67)">
            ...
            <div data-scrolly-down="moveFromBottom, delay:0.5s, timing-function:cubic-bezier(.17,.67,.83,.67)">
    ...
    <section class="bg-white p-6 sm:p-14 grid gap-8 md:grid-cols-2" data-scrolly-down="blurInTop, moveFromRight, timing-function:cubic-bezier(.17,.67,.83,.67)" data-scrolly-offset-top="200px">  
