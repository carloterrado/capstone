    ...
    <div class="relative w-full max-w-4xl m-auto bg-white rounded-lg content-container">
        ...
        @include('message.loading')
            <div class="form-step step-one pb-6">
                <div class="flex justify-between px-2 pt-2 pb-2 sm:px-6 rounded-t items-center ">
                  
                    <button  type="button" class=" cursor-pointer text-gray-400 bg-transparent hover:bg-accent-regular hover:text-white rounded-lg text-sm p-1.5 mr-auto inline-flex items-center" >
                        <svg xmlns="http://www.w3.org/2000/svg" class="download-checklist" width="40" height="40" viewBox="0 0 24 24"><path fill="currentColor" d="M5 3h14a2 2 0 0 1 2 2v14c0 1.11-.89 2-2 2H5a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2m3 14h8v-2H8v2m8-7h-2.5V7h-3v3H8l4 4l4-4Z"/></svg>
                    </button>
