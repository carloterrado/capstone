<div id="{{ 'view-car' . $car['id'] }}" tabindex="-1" aria-hidden="true"
        ...
        <form class="car-booking-form form relative bg-white rounded-lg shadow" enctype="multipart/form-data">
            ...
            <div class="form-step step-one pb-6">
                <div class="flex justify-between px-2 pt-6 pb-4 sm:p-6 rounded-t items-center relative">
                    ...
                    <button data-modal-toggle="{{ 'view-car' . $car['id'] }}" type="button" before="Close"
                    ...
                    <div class="col-span-8 md:col-span-5 mb-6">
                        {{-- <div class="relative h-42 sm:h-56 overflow-hidden" id="car-photos">
                            <a class="zoomable-image" href="data:image/jpeg;base64,{{ $car['main_photo'] }}">
                                <img src="data:image/jpeg;base64,{{ $car['main_photo'] }}"
                                    class="h-full w-full object-cover" alt="..."></a>
                        </div> --}}
                        <div class=" relative" data-carousel="static"> 
                           ...
                           <div class="relative h-56 overflow-hidden rounded-lg " id="car-photos">
                               ...
                               <a class="zoomable-image" href="data:image/jpeg;base64,{{$photo['photos']}}">
                                   <img src="data:image/jpeg;base64,{{$photo['photos']}}" class="absolute block w-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 " alt="...">
                                </a>
                               </div>
                               @endforeach
                           </div>
                        ...
                        <div class="my-6 bg-[#f5f5f5]">
                            <ul class="grid grid-cols-6 -mb-px text-sm font-medium text-center "
                                id="{{ 'car' . $car['id'] }}" data-tabs-toggle="{{ '#car-content' . $car['id'] }}"
                                role="tablist">
                                <li class="mr-2 col-span-6 sm:col-span-2" role="presentation">
                                    <button
                                        class="car-tab inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-accent-regular hover:border-accent-regular uppercase"
                                        id="{{ 'car-details-tab' . $car['id'] }}"
                                        data-tabs-target="{{ '#car-details' . $car['id'] }}" type="button"
                                        role="tab" aria-controls="{{ 'car-details' . $car['id'] }}"
                                        aria-selected="false">Car
                                        Details</button>
                                </li>
                                <li class="mr-2 col-span-6 sm:col-span-2" role="presentation">
                                    <button class="car-tab inline-block p-4 border-b-2 rounded-t-lg uppercase"
                                        id="{{ 'car-description-tab' . $car['id'] }}"
                                        data-tabs-target="{{ '#car-description' . $car['id'] }}" type="button"
                                        role="tab" aria-controls="{{ 'car-description' . $car['id'] }}"
                                        aria-selected="false">Description</button>
                                </li>
                                <li class="mr-2 col-span-6 sm:col-span-2" role="presentation">
                                    <button
                                        class="car-tab inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-accent-regular hover:border-accent-regular uppercase"
                                        id="{{ 'car-excluded-tab' . $car['id'] }}"
                                        data-tabs-target="{{ '#car-excluded' . $car['id'] }}" type="button"
                                        role="tab" aria-controls="{{ 'car-excluded' . $car['id'] }}"
                                        aria-selected="false">Excluded</button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="{{ 'car-content' . $car['id'] }}">
                            <div class="hidden p-4" id="{{ 'car-details' . $car['id'] }}" role="tabpanel"
                                aria-labelledby="{{ 'car-details-tab' . $car['id'] }}">
                                ...
                                <div class="grid grid-cols-6 border-b-2 mb-4">
                                    ...
                                    <p class="col-span-3 text-sm font-semibold capitalize">{{ $car['fuel_type'] }}</p>
                                </div>
                                <div class="grid grid-cols-6 border-b-2 mb-4">
                            ...
                            <div class="hidden p-4" id="{{ 'car-description' . $car['id'] }}" role="tabpanel"
                                aria-labelledby="{{ 'car-description-tab' . $car['id'] }}">
                                <p class="text-sm ">{{ $car['description'] }}</p>
                            </div>
                            <div class="hidden p-4" id="{{ 'car-excluded' . $car['id'] }}" role="tabpanel"
                                aria-labelledby="{{ 'car-excluded-tab' . $car['id'] }}">
                                <div class="border-b-2 mb-4">
                                    <h3 class="text-sm font-semibold"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="border-b-2 mb-4">
                                    <h3 class="text-sm font-semibold"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 15 15">
                                            <path fill="currentColor"
                                                d="M1 13V2h4.5a3.5 3.5 0 0 1 3.21 2.103a3.36 3.36 0 0 0-.504.676c-.23.41-.232.837-.174 1.154l.3 1.625A3.495 3.495 0 0 1 5.5 9H3v4H1Zm4.5-6a1.5 1.5 0 1 0 0-3H3v3h2.5Zm3.516-1.248a.716.716 0 0 1 .062-.484C9.315 4.848 9.978 4 11.5 4c1.521 0 2.185.847 2.421 1.268a.716.716 0 0 1 .064.484L13.019 11H12v2h-1v-2H9.981l-.965-5.248ZM12.75 7L13 5.655C12.83 5.409 12.42 5 11.5 5s-1.33.41-1.5.655L10.25 7h2.5Z" />
                                ...
                                <div class="border-b-2 mb-4">
                                    <h3 class="text-sm font-semibold"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                                d="M20.475 23.3L19 21.825V22h-2v-2.175L.675 3.5L2.1 2.075l19.8 19.8ZM19 16.125l-2.075-2.075L14 11.125V7q0-2.075 1.463-3.537Q16.925 2 19 2Zm-7-7l-2-2V2h2Zm-3-3l-2-2V2h2Zm-3-3L4.875 2H6ZM7 22v-9.15q-1.275-.35-2.137-1.4Q4 10.4 4 9V3.975l2 2V9h1V6.975l2.025 2l2.25 2.275q-.4.575-.987.987Q9.7 12.65 9 12.85V22Z" />
                                        </svg> <span>Driver's Meal</span></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-8 md:col-span-3">
                        <div class="bg-[#f5f5f5] pb-4">
                            <div class="p-4 bg-[#302E2E]">
                                <h3 class="text-lg sm:text-xl font-semibold text-white text-center mb-2 ">
                                    {{ '₱' . number_format($car['carPrice'][3]['price'], 2, '.', ',') }} <span
                                        class="text-accent-regular"> / Day</span></h3>
                            ...
                            <div class="p-2 md:p-6 md:pb-4 sm:pt-0">
                                        ...
                                        <div class="range-input relative">
                                            ...
                                            <div class="relative">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="absolute right-2 top-2 pointer-events-none z-50"
                                                ...
                                                <input type="text" value="" name="date"
                                                    data-bookdates="{{ json_encode($car['carBooking']) }}"
                                                    class="date-input block px-2.5 py-2 w-full text-xs text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-300 mb-2"
                                            ...
                                            <div class="mt-2 items-center">
                                                <label
                                                    class="w-fit mb-2 text-sm font-semibold text-gray-900 uppercase text-center mr-2 mt-1">Pick
                                                    Up Time: </label>
                                                <input type="time" name="book-time"
                                                    class="time-input w-full bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:outline-none focus:ring-0 focus:border-gray-900 block px-2.5 py-2 uppercase"
                                                    placeholder="Select time">
                                            </div>
                                            <div class=" mt-2 items-center">
                                                <label
                                                    class="w-fit mb-2 text-sm font-semibold text-gray-900 uppercase text-center mr-2 mt-1">Drop
                                                    Off Time: </label>
                                                <input type="time" name="book-time-end"
                                                    class="time-end-input w-full bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:outline-none focus:ring-0 focus:border-gray-900 block px-2.5 py-2 uppercase"
                                                    placeholder="Select time">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-4">
                                    <input type="hidden" value="{{ $car['carPrice'][3]['price'] }}"
                                        name="car-price" class="car-price">
                                    <label
                                        class="block mb-2 text-sm font-semibold text-gray-900 uppercase ">Destination
                                    </label>
                                    <!-- <label class="block mb-2 text-xs font-medium text-gray-900 uppercase">Region: </label> -->
                                    <select name="region" data-price="{{ json_encode($car['carPrice']) }}"
                                        class="region bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:outline-none focus:ring-0 focus:border-gray-900 block w-full p-2.5 ">
                                ...
                                <div class="mt-4">
                                    ...
                                    <select name="province"
                                        class="province bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:outline-none focus:ring-0 focus:border-gray-900 block w-full p-2.5 ">
                                ...
                                <div class="mt-4">
                                    ...
                                    <select name="city"
                                        class="city bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:outline-none focus:ring-0 focus:border-gray-900 block w-full p-2.5 ">
                                ...
                                @if ($car['driver'] === '1')
                                    <div class="mt-4">
                                        ...
                                        <label
                                            class="block mb-2 text-sm font-semibold text-gray-900 uppercase text-center">Rent
                                            option </label>
                                        <select name="driver" data-driver="{{ $car['drivers_fee'] }}"
                                            class="driver bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:outline-none focus:ring-0 focus:border-gray-900 block w-full p-2.5 ">
                            ...
                            <div class="mt-6 px-6">
                                <button type="button"
                                    class="step-2 btn-1 bg-accent-regular w-full   text-white whitespace-nowrap uppercase">Reserve
                                    this car</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3 relative">
                            <input type="text" name="fullname"
                                ...
                                class="fullname block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-900 peer"
                                placeholder=" ">
                            <label
                                class="fullname-error pointer-events-none absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-gray-900 peer-focus:font-semibold peer-placeholder-shown:scale-100 
                            peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1 whitespace-nowrap ">Full
                                Name</label>
                        </div>
                        <div class="col-span-6 sm:col-span-3 relative">
                            <input type="text" name="contact" value="{{ Auth::user()->contact }}"
                                class="contact block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-900 peer"
                                placeholder=" ">
                            <label
                                class="contact-error pointer-events-none absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-gray-900 peer-focus:font-semibold peer-placeholder-shown:scale-100 
                        ...
                        <div class="col-span-6 license-container">
                            <label
                                class="license-error block pb-1 text-sm font-semibold lg:pl-2 text-gray-500">Driver's
                                License</label>
                            <input type="file" name="license"
                                class="license block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                aria-describedby="file_input_help">

                        </div>
                        <div class="col-span-6">
                            <label class="valid-id-error block pb-1 text-sm font-semibold lg:pl-2 text-gray-500">Valid
                                ID</label>
                            ...
                            <input type="file" name="valid-id"
                                class="valid-id block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                aria-describedby="file_input_help">
                        </div>
                        <div class="col-span-6">
                            <div class="relative mb-2">
                                ...
                                <label id="owner-signup-valid-id-error" for="owner-signup-valid-id"
                                    class="pointer-events-none absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-gray-900 peer-focus:font-semibold peer-placeholder-shown:scale-100 
                                    peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1 whitespace-nowrap">Choose
                                    another valid id</label>
                            </div>
                            <input type="file" name="valid-id-2"
                                class="valid-id-2 block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                aria-describedby="file_input_help">
                        </div>
                        
                        <div class="col-span-6  relative">
                            <input type="text" name="address" value="{{ Auth::user()->address }}"
                                class="address block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-900 peer"
                                placeholder=" ">
                            <label
                                class="address-error pointer-events-none absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-gray-900 peer-focus:font-semibold peer-placeholder-shown:scale-100 
                        ...
                        <div class="col-span-6">
                            <label class="utility-error block pb-1 text-sm font-semibold lg:pl-2 text-gray-500">Proof of Address (Latest
                                Electric/Water Bill)</label>
                            <input type="file" name="utility"
                                class="utility block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                aria-describedby="file_input_help">
                        </div>
                    </div>
                </div>
                <div
                    class="flex items-center flex-wrap sm:justify-between p-6 space-y-2 sm:space-y-0 sm:space-x-2 rounded-b border-t border-gray-200 ">
                    <button type="button"
                        class="step-1 btn-1 bg-accent-regular uppercase w-full  sm:w-[fit-content]   text-white whitespace-nowrap">Previous</button>
                    <button type="button"
                        class="step-3 btn-1 bg-accent-regular uppercase  w-full sm:w-[fit-content]   text-white whitespace-nowrap">Next</button>
                </div>
            </div>
                ...
                <div class="px-6 space-y-6">
                    <div class="grid grid-cols-6 gap-2 md:gap-4 font-semibold">
                        <div class="col-span-6 gap-2 grid grid-cols-6">
                            ...
                            <p class="col-span-6 sm:col-span-5 bg-[#f5f5f5]  py-2 px-3 capitalize confirm-destination">
                                Lorem </p>
                        </div>
                        <div class="col-span-6 gap-2 grid grid-cols-6">
                        ...
                        <div class="col-span-6 gap-2 grid grid-cols-6">
                            ...
                            <p class="bg-[#f5f5f5]  py-2 px-3 col-span-6 sm:col-span-5 confirm-start-date">dd-mm-yyyy
                            </p>
                        </div>
                        <div class="col-span-6 gap-2 grid grid-cols-6">
                        ...
                        <div class="flex items-center mt-4 col-span-6">
                            <input name="booking-terms" value="agree" type="checkbox"
                                class="booking-terms w-4 h-4 text-accent-regular bg-gray-100 rounded border-gray-300 focus:ring-0  ">
                            <label class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the
                                <a href="javascript:void(0)" data-modal-toggle="terms-and-conditions"
                                    class="text-accent-regular  hover:underline">terms and conditions</a>.</label>
                        </div>
                        <label
                            class="booking-form-error hidden col-span-6 pb-1 text-sm font-semibold lg:pl-2 text-[lightcoral]">Please
                            check the Terms and Conditions</label>
                        <div class="bg-accent-regular rounded-full h-1 col-span-6"></div>
                    </div>
                </div>
                <div
                    class="flex items-center flex-wrap sm:justify-between p-6 space-y-2 sm:space-y-0 sm:space-x-2 rounded-b">
                    <button type="button"
                        class="step-2 btn-1 bg-accent-regular uppercase w-full  sm:w-[fit-content]   text-white whitespace-nowrap">Previous</button>
                    <button type="submit"
                        class="edit-step-3 btn-1 bg-accent-regular uppercase  w-full sm:w-[fit-content]   text-white whitespace-nowrap">Submit</button>
                </div>
            </div>
        </form>
    </div>
