    ...
    <form  class="relative bg-white rounded-lg shadow ">
        ...
        <div class="view-step detail-one pb-6">
                    ...
                    <div id="{{'car-content'.$car['id']}}">
                        ...
                        <div class="hidden p-4" id="{{'car-excluded'.$car['id']}}" role="tabpanel" aria-labelledby="{{'car-excluded-tab'.$car['id']}}">
                            <div class="border-b-2 mb-4">
                                <h3 class="text-sm font-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="inline-block" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M18 10a1 1 0 0 1-1-1a1 1 0 0 1 1-1a1 1 0 0 1 1 1a1 1 0 0 1-1 1m-6 0H6V5h6m7.77 2.23l.01-.01l-3.72-3.72L15 4.56l2.11 2.11C16.17 7 15.5 7.93 15.5 9a2.5 2.5 0 0 0 2.5 2.5c.36 0 .69-.08 1-.21v7.21a1 1 0 0 1-1 1a1 1 0 0 1-1-1V14a2 2 0 0 0-2-2h-1V5a2 2 0 0 0-2-2H6c-1.11 0-2 .89-2 2v16h10v-7.5h1.5v5A2.5 2.5 0 0 0 18 21a2.5 2.5 0 0 0 2.5-2.5V9c0-.69-.28-1.32-.73-1.77Z"/></svg> <span>Fuel</span></h3>  
                            </div>
                            <div class="border-b-2 mb-4">
                                <h3 class="text-sm font-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="inline-block" preserveAspectRatio="xMidYMid meet" viewBox="0 0 15 15"><path fill="currentColor" d="M2.5 1a.5.5 0 0 0-.5.5V13h-.5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1H7v-2.901l6.776-4.553a.5.5 0 0 0 .136-.694l-.279-.415a.5.5 0 0 0-.693-.136L7 8.29V2h.5a.5.5 0 0 0 0-1h-5ZM3 3.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-4Z"/></svg> <span>Toll Fees</span></h3>  
                            </div>
                            <div class="border-b-2 mb-4">
                                <h3 class="text-sm font-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="inline-block" preserveAspectRatio="xMidYMid meet" viewBox="0 0 15 15"><path fill="currentColor" d="M1 13V2h4.5a3.5 3.5 0 0 1 3.21 2.103a3.36 3.36 0 0 0-.504.676c-.23.41-.232.837-.174 1.154l.3 1.625A3.495 3.495 0 0 1 5.5 9H3v4H1Zm4.5-6a1.5 1.5 0 1 0 0-3H3v3h2.5Zm3.516-1.248a.716.716 0 0 1 .062-.484C9.315 4.848 9.978 4 11.5 4c1.521 0 2.185.847 2.421 1.268a.716.716 0 0 1 .064.484L13.019 11H12v2h-1v-2H9.981l-.965-5.248ZM12.75 7L13 5.655C12.83 5.409 12.42 5 11.5 5s-1.33.41-1.5.655L10.25 7h2.5Z"/></svg> <span>Parking Fees</span></h3>  
                            </div>
                            <div class="border-b-2 mb-4">
                                <h3 class="text-sm font-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="inline-block" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M20.475 23.3L19 21.825V22h-2v-2.175L.675 3.5L2.1 2.075l19.8 19.8ZM19 16.125l-2.075-2.075L14 11.125V7q0-2.075 1.463-3.537Q16.925 2 19 2Zm-7-7l-2-2V2h2Zm-3-3l-2-2V2h2Zm-3-3L4.875 2H6ZM7 22v-9.15q-1.275-.35-2.137-1.4Q4 10.4 4 9V3.975l2 2V9h1V6.975l2.025 2l2.25 2.275q-.4.575-.987.987Q9.7 12.65 9 12.85V22Z"/></svg> <span>Driver's Meal</span></h3>  
                            </div>
                        </div>    
                    </div>
                </div>
            ...
            <!-- <div class="flex items-center justify-end px-2 py-6 sm:p-6  space-x-2 rounded-b  border-gray-200 "> 
                <button type="button" class="second-details details btn-1 bg-accent-regular uppercase  w-full sm:w-[fit-content]   text-white whitespace-nowrap">Book now</button>
            </div> -->
        </div>
