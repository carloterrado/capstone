<?php
    ...
    $inputDate = explode('-', Auth::user()->birthdate ); 
        ...
        <form id="edit-profile-form" method="POST"  enctype="multipart/form-data" class="relative bg-white rounded-lg shadow ">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3 relative">
                        <input type="text" id="edit-last-name" name="edit-last-name" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-900 peer" placeholder=" " value="{{Auth::user()->last_name}}" />
                    ...
                    <div class="col-span-6 sm:col-span-3 relative">
                        <input type="text" id="edit-contact" name="edit-contact" value="{{Auth::user()->contact}}" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-900 peer" placeholder=" " />
                    ...
                    <div class="col-span-6 relative">
                        <input type="text" id="edit-address" name="edit-address" value="{{Auth::user()->address}}" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-900 peer" placeholder=" " />
