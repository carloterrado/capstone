    ...
    <section class="bg-white p-6 sm:p-14 grid gap-8 md:grid-cols-2">
        ...
        <div class="h-[400px] sm:h-[100vh] relative">
            ...
            <div class="absolute top-1/4 sm:top-1/2 left-1/2 translate-x-[-50%] w-[90%] md:w-9/12 ">
                ...
                <button class="scale-75 sm:scale-100 btn-orange-sidebar w-[fit-content] lg:w-[300px] outline-offset-0 whitespace-nowrap mx-auto block">Become a car rental owner</button>
            </div>
        </div>
